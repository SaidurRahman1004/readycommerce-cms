...
export type AdminProduct = { _id: string; name: string; slug: string; description?: string; shortDescription?: string; category?: { _id: string; name: string }; basePrice: number; discountPrice?: number; images: string[]; status: string; isFeatured?: boolean; isSpecialOffer?: boolean; variants: Array<{ _id: string; sku: string; name: string; price: number; stock: number }> };
