...
export default function Navbar({locale}: {locale: string}) {
  ...
  return <header className="sticky top-0 z-40 border-b border-slate-200/70 bg-[#fafbff]/90 backdrop-blur-xl"><div className="mx-auto flex min-h-[72px] max-w-7xl items-center justify-between gap-3 px-5 py-3 sm:px-8 lg:px-10">
