      ...
      <div className="flex flex-1 flex-col justify-between p-2 pt-4">
        <div>
          <div className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 text-[11px] font-bold text-amber-500" aria-label={`${product.ratingAverage || 0} out of 5 stars`}>
              ...
              {product.ratingAverage ? product.ratingAverage.toFixed(1) : '—'}{product.reviewCount ? <span className="text-muted-foreground">({product.reviewCount})</span> : null}
            </div>
          </div>
